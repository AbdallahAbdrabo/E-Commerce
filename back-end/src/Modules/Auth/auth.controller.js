...
// -------------------------forget provider------------------
// export const forgetPassword_provider = async (req, res, next) => {
//     const { email } = req.body
//     const user = await brandModel.findOne({ email })
//     if (!user) {
//         return next(new Error('invalid email', { cause: 400 }))
...
//     const resetPasswordLink = `${req.protocol}://${req.headers.host}/auth/reset_provider/${token}`
...
//     const userUpdates = await brandModel.findOneAndUpdate(
//         { email },
//         {
//             forgetCode: code,
//         },
...
// }
// // -------------------------reset provider------------------
// export const resetPassword_provder = async (req, res, next) => {
//     const { token } = req.params
